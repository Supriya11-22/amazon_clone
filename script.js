...
// Select elements
window.showSigninDropdown = function () {
    let dropdown = document.querySelector(".signin-dropdown");
    dropdown.style.opacity = "1";
    dropdown.style.visibility = "visible";
};

window.hideSigninDropdown = function () {
    let dropdown = document.querySelector(".signin-dropdown");
...
if (signinButton && signinDropdown) {
    ...
    console.error("Signin elements not found!");
}
